...
/**
 * ML-DSA-44 (Dilithium) public-key expansion + ABI encoding for on-chain storage.
 *
 * Ported verbatim from the reference example (`utils_mldsa.ts`). The ZKNOX account's
...
/**
 * Expand + ABI-encode an ML-DSA-44 public key into the `bytes` blob the ZKNOX
 * factory/account stores on-chain.
 */
